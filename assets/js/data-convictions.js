/* ============================================================
   ...
   data-convictions.js — "Our Convictions" (About)
   ------------------------------------------------------------
   Drives the About convictions VerticalExplorer. Enduring
   convictions, not generic values. Each: id, title, role, why
   (why it matters), practice (how it shows up in the work).
   Edit ONLY this file to change the convictions.
...
window.BUSARA_CONVICTIONS = [
  {
    ...
    practice: 'We will not design until observation, listening and research have told us what the problem actually is \u2014 even when that is slower, and even when it changes the brief.'
  },
  {
    id: '02',
    ...
    practice: 'When evidence contradicts a plan we hold, the evidence wins. Validation exists precisely so that assumptions can be set aside before they become architecture.'
  },
  {
    id: '03',
    ...
    practice: 'We build for decades, not for a funding round. Governance, membership and accountability are designed before a line of platform code is written.'
  },
  {
    id: '04',
    ...
    practice: 'We show our work \u2014 the research, the validation, the decisions and the open questions \u2014 so trust is offered on evidence the visitor can see, not on our say-so.'
  },
  {
    id: '05',
    ...
    practice: 'Technology is the final stage of our method, not the first. It is chosen to serve a validated need, and it answers to the institution \u2014 not the other way around.'
  }
];
